        ...
        function _typeof(e) {
            ...
            $.fn.fileuploader = function(q) {
                                ...
                                renderThumbnail: function(e, t, r) {
                                    ...
                                    if (i.length) {
                                        if (e.image = i.html("").addClass("fileuploader-loading"), (["image", "video", "audio", "astext"].indexOf(e.format) > -1 || e.data.thumbnail) && f.isFileReaderSupported() && !a && (e.appended || n.thumbnails.startImageRenderer || t)) {
                                            ...
                                            return "string" == typeof r ? h(r) : f.files.read(e, function() {
                                    ...
                                    if (n.thumbnails.popup && n.thumbnails._selectors.popup) {
                                        var r = $(n.thumbnails.popup.container),
                                            ...
                                            a = function() {
                                                ...
                                                i.removeClass("loading"), i.children(n.thumbnails._selectors.popup).length && ($.each(f._itFl, function(o, n) {
                            ...
                            editor: {
                                ...
                                resize: function(e, t, o, n, r, i) {
                                    ...
                                    if (t.width = s, t.height = p, e.width < t.width || e.height < t.height || d < 2) {
                                        ...
                                        r || (a.fillStyle = "#fff", a.fillRect(0, 0, t.width, t.height)), a.drawImage(e, u, f, Math.min(e.width, t.width), Math.min(e.height, t.height))
                                    } else {
                            ...
                            sorter: {
                                ...
                                findItemAtPos: function(e) {
                                    ...
                                    return o.each(function(t, o) {
                                        var r = $(o);
                                        if (e.x > r.offset().left && e.x < r.offset().left + r.outerWidth() && e.y > r.offset().top && e.y < r.offset().top + r.outerHeight()) return n = r, !1
                                    }), n
                                },
                                    ...
                                    if (e.upload) {
                                        ...
                                        if (n.upload.chunk && e.file.slice) {
                                            ...
                                            if (d > 1 && !e.upload.chunk && (e.upload.chunk = {
                                                    name: e.name,
                                                    title_custom: e.title_custom,
                                                    subtitle_custom: e.subtitle_custom,
                                                    size: e.file.size,
                                                    type: e.file.type,
                                                    chunkSize: a,
                                                    temp_name: e.name,
                            ...
                            files: {
                                add: function(e, t) {
                                    var o, r, i = e._name || e.name,
                                        ...
                                        l = e.subtitle_custom,
                                        p = e.size,
                                        d = f._assets.bytesToText(p),
                                        u = e.type,
                                        c = u ? u.split("/", 1).toString().toLowerCase() : "",
                                        h = -1 != i.indexOf(".") ? i.split(".").pop().toLowerCase() : "",
                                        m = i.substr(0, i.length - (-1 != i.indexOf(".") ? h.length + 1 : h.length)),
                                        g = {
                                            name: i,
                                            title: m,
                                            title_custom: a,
                                    ...
                                    return "updated" != t ? (f._itFl.push(g), o = f._itFl.length - 1, r = f._itFl[o]) : (o = f._itFl.indexOf(e), f._itFl[o] = r = g), r.remove = function() {
                                        f.files.remove(r)
                                    }, n.editor && "image" == c && (r.editor = {
                                        rotate: function(e) {
                                            f.editor.rotate(r, e)
                                        },
                                        cropper: function(e) {
                                                    ...
                                                    e.data && e.data.readerCrossOrigin && o.setAttribute("crossOrigin", e.data.readerCrossOrigin), o.src = t.target.result + (i && !c && -1 == t.target.result.indexOf("data:image") ? (-1 == t.target.result.indexOf("?") ? "?" : "&") + "d=" + Date.now() : ""), o.onload = function() {
                                                        if (e.reader.exifOrientation) {
                                                            var t = document.createElement("canvas"),
                                                                ...
                                                                a = [0, 180];
                                                            t.width = r.naturalWidth, t.height = r.naturalHeight, n.drawImage(r, 0, 0), t.width = a.indexOf(i) > -1 ? r.naturalWidth : r.naturalHeight, t.height = a.indexOf(i) > -1 ? r.naturalHeight : r.naturalWidth;
                                                            var l = i * Math.PI / 180,
                                                                s = .5 * t.width,
                                                                p = .5 * t.height;
                                                            return n.clearRect(0, 0, t.width, t.height), n.translate(s, p), n.rotate(l), n.translate(.5 * -r.naturalWidth, .5 * -r.naturalHeight), n.drawImage(r, 0, 0), n.setTransform(1, 0, 0, 1, 0, 0), o.src = t.toDataURL(e.type, 1), void delete e.reader.exifOrientation
                                                        }
                                ...
                                list: function(e, t, r, i) {
                                    ...
                                    return !n.sorter || r || i && "ignoreSorter" == i || f.sorter.save(!0), $.each(f._itFl, function(o, n) {
                                        ...
                                        var r = n,
                                            i = r.title_custom ? r.title_custom : "",
                                            l = r.subtitle_custom ? r.subtitle_custom : "";
                                        if ((t || e) && (r = (r.choosed ? "0:/" : "") + (t && null !== f.files.getItemAttr(n, t) ? f.files.getItemAttr(n, t) : n["string" == typeof n.file ? "file" : "name"])), e && (r = {
                                            ...
                                            for (var s in n.data.listProps) r[s] = n.data.listProps[s];
                                        a.push(r)
                            ...
                            _assets: {
                                ...
                                secondsToText: function(e, t) {
                                    ...
                                    var o = Math.floor(e / 3600),
                                        ...
                                        r = "";
                                    return (o > 0 || !t) && (r += (o < 10 ? "0" : "") + o + (t ? "h " : ":")), (n > 0 || !t) && (r += (n < 10 && !t ? "0" : "") + n + (t ? "m " : ":")), r += ((e = e - 3600 * o - 60 * n) < 10 && !t ? "0" : "") + e + (t ? "s" : "")
                                },
                                pxToRatio: function(e, t) {
                                    var o = function e(t, o) {
                                        return 0 == o ? t : e(o, t % o)
                                    }(e, t);
                                    return [e / o, t / o]
                                },
                                ...
                                arrayBufferToBase64: function(e) {
                                    for (var t = "", o = new Uint8Array(e), n = 0; n < o.byteLength; n++) t += String.fromCharCode(o[n]);
                                ...
                                isBrightColor: function(e) {
                                    return function(e) {
                                        ...
                                        return n ? .2126 * n[0] + .7152 * n[1] + .0722 * n[2] : null
                                    }(e) > 194
                                }
                            },
                ...
                captions: {
                    ...
                    paste: '<div class="fileuploader-pending-loader"><div class="left-half" style="animation-duration: ${ms}s"></div><div class="spinner" style="animation-duration: ${ms}s"></div><div class="right-half" style="animation-duration: ${ms}s"></div></div> Colando o arquivo, clique aqui para cancelar.',
                    removeConfirmation: "Você tem certeza que deseja remover este arquivo?",
                    errors: {
                        filesLimit: "Apenas arquivos com até ${limit} são permitidos.",
                        filesType: "Apenas arquivos ${extensions} são permitidos",
                        fileSize: "${name} é muito grande! Por favor escolha um arquivo com no máximo ${fileMaxSize}MB.",
                        filesSizeAll: "Os arquivos selecionados são muito grandes! or favor escolha arquivos com no máximo ${maxSize} MB.",
                        fileName: "O arquivo com o nome ${name} já foi selecionado.",
                        folderUpload: "Você não esta autorizado a enviar pastas."
                    }
                }
            }, $(document).on("click", ".fileuploader-popup-button.button-success, .fileuploader-popup-move", function() {
                var e = $(this).parents(".fileuploader-popup-preview"),
                    t = $("input[name='fileuploader-list-slides']"),
                    o = JSON.parse(t.val());
                    console.log(o);
                $(o).each(function(t, n) {
                    n.file.replace("0:/", "") == e.find(".fileuploader-popup-meta li:first h5").text() && (o[t].title = e.find(".input-title").val(), o[t].subtitle = e.find(".input-subtitle").val())
